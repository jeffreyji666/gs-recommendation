package com.ctrip.gs.recommendation.hdfs;
...
public class HdfsSequenceFileWriter {
	...
	private SequenceFile.Writer initWriter() {
		try {
			...
			writer = SequenceFile.createWriter(fs, conf, filePath, key.getClass(), val.getClass(), CompressionType.BLOCK);
		} catch (IOException e) {
